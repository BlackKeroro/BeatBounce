...
public class Star : MonoBehaviour
{
    ...
    public List<Light> data = new List<Light>();
    ...
    public void Parse()
    {
        ...
        //제이슨 파서
        //경로의 파일 불러옴
        string json = File.ReadAllText(Application.dataPath + "/Resources/Star.json");
        //제이슨파일 직렬화 해제
        data = JsonConvert.DeserializeObject<List<Light>>(json);
